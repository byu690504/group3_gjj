            ...
            <form action="<%=request.getContextPath() %>/change/personRegister" method="post" class="layui-form">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="agentName" value="${agentName}" readonly autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">经办人证件号码</label>
                    <div class="layui-input-block">
                        <input type="text" name="agentCardNumber" value="${agentCardNumber}" readonly autocomplete="off" class="layui-input">
                    </div>
                </div>
