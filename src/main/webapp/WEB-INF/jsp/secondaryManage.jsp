    ...
    <script type="text/javascript">
        layui.use(['layer', 'table', 'form'], function () {
            ...
            table.render({
                ...
                page : true,
                cols : [ [
                    {field : '',title : '序号',align : 'center',width : 150},
                    {field : '',title : '部门编号',align : 'center',width : 300},
                    {field : '',title : '部门名称',align : 'center',width : 300},
                    {field : '',title : '部门代码',align : 'center',width : 300},
